...
function EnemyDataBase(game, spritesheet) {
    ...
    },                 
    {
        ...
        HPBar: new HealthBar(game,AM.getAsset("./img/RedHealthBar.png"),
                            AM.getAsset("./img/GreenHealthBar.png"), AM.getAsset("./img/OrangeBlockBar.png"), 120, this.hpbarwidth, this.hpbarheight),
    ...
    },
    {
        ...
        HPBar: new HealthBar(game,AM.getAsset("./img/RedHealthBar.png"),
                            AM.getAsset("./img/GreenHealthBar.png"),AM.getAsset("./img/OrangeBlockBar.png"), 150, this.hpbarwidth, this.hpbarheight),
    ...
    },
    {
        ...
        HPBar: new HealthBar(game,AM.getAsset("./img/RedHealthBar.png"),
                            AM.getAsset("./img/GreenHealthBar.png"), AM.getAsset("./img/OrangeBlockBar.png"),180, this.hpbarwidth, this.hpbarheight),
    ...
    },
    {
        ...
        HPBar: new HealthBar(game,AM.getAsset("./img/RedHealthBar.png"),
                            AM.getAsset("./img/GreenHealthBar.png"),AM.getAsset("./img/OrangeBlockBar.png"), 170, this.hpbarwidth, this.hpbarheight),
